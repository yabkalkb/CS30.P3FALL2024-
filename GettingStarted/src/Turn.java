...
public class Turn {
    public static void main(String[] args) throws Exception {
        ...
        Thread.sleep(4000);  // Move forward for 3 seconds

        // Turn 180° - rotate in place
        leftMotors.setTargetVelocity(1);  // Left motor reverse (backward)
